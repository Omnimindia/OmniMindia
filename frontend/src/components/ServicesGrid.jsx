...
const SERVICES = [
  {
    ...
    description: 'Deploy intelligent processing at the edge. Reduce latency, enhance privacy, and optimize bandwidth with hardware-aware AI.',
    icon: (
  ...
  },
  {
    ...
    description: 'Seamlessly orchestrate workloads across cloud providers. Multi-cloud strategies with unified management and monitoring.',
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
  ...
  },
  {
    ...
    description: 'AI-powered robotic systems for warehouses, logistics, and autonomous operations. Real-time decision making at scale.',
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
  ...
  },
  {
    ...
    description: 'Intelligent workload placement based on hardware capabilities. GPU, TPU, NPU orchestration for maximum efficiency.',
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
  ...
  },
  {
    ...
    description: 'Instant insights from distributed data sources. Stream processing and edge analytics for time-critical decisions.',
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
  ...
  },
  {
    ...
    description: 'Zero-trust architecture with end-to-end encryption. Meet regulatory requirements across industries.',
    icon: (
      <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
...
/**
 * Services grid showcasing OmniMindia capabilities
 */
